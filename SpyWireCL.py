...
class Peer:
    ...
    socketList = []
    printList = []
    peerList = [] ##all possible peers in format (ip:port)
    socketBuffer = []
    userName = ''
    key = ""
    rc4 = None
    port = 9091 ##Change this number when testing locally via two separate consoles.
    ...
    def getPeersFromFile (self):
        ...
        for socketPair in socketPairs:
            ...
            self.peerList.append(socketPair)
        socketListFile.close()
